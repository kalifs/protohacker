...
From https://protohackers.com/problem/4
...
```
printf 'version' | nc -u localhost 5000
printf 'foo=bar' | nc -u localhost 5000
printf 'foo' | nc -u localhost 5000
```
