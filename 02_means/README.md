# Means to an end
From https://protohackers.com/problem/2
...
```
printf '\x49\x00\x00\x30\x39\x00\x00\x00\x65\x49\x00\x00\x30\x3a\x00\x00\x00\x66\x49\x00\x00\x30\x3b\x00\x00\x00\x64\x49\x00\x00\xa0\x00\x00\x00\x00\x05\x51\x00\x00\x30\x00\x00\x00\x40\x00' | nc -N localhost 8080 | xxd
```

Should return 4 bytes with number **101**
